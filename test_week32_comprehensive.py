...
def test_week32_comprehensive():
    """Test the universal parser on Week 32, 2025 for comparison"""
    print("=== TESTING UNIVERSAL PARSER ON WEEK 32, 2025 ===")
    ...
    with pd.ExcelWriter('week32_verification_2025.xlsx', engine='openpyxl') as writer:
    ...
    print(f"✅ Excel file created: week32_verification_2025.xlsx")
    ...
    print(f"   Sheet 10: Parser_Performance - Overall parser performance metrics")
    
    return daily_summaries

if __name__ == "__main__":
    test_week32_comprehensive()
